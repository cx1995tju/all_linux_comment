...
#define MAX_TCP_HEADER	L1_CACHE_ALIGN(128 + MAX_HEADER) // 128 + 32 对齐到 64B 就是 192B
...
#define TCP_TIMEOUT_INIT ((unsigned)(1*HZ))	/* RFC6298 2.1 initial RTO value	*/ // 1s
...
// linux 的 timestamp 增长的基本单位是 HZ, 每个 HZ 会增长一点
// 时钟粒度是 ms
