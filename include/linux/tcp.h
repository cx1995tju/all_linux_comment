...
#define TCP_RACK_RECOVERY_THRESH 16		// 发生了太多 recovery 之后(refer to: %tcp_try_undo_recovery())，认为之前测量的 reo_wnd_step 已经不可靠了，就会 reset 为1，重新测量
	...
	u8	nonagle     : 4,/* Disable Nagle algorithm?             */
		...
		repair      : 1,
		frto        : 1;/* F-RTO (RFC5682) activated in CA_Loss  表示当时是否在运行 f-rto 算法*/
	u8	repair_queue;
...
/* RTT measurement */
	...
	u32	srtt_us;	/* smoothed round trip time << 3 in usecs  */ // 采样的 rtt 值 向左移动了 3b。向右移动 3b才是 us, ref: __tcp_set_rto
